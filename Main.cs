...
using STS2ShowIncomingDamage.Patches;
using STS2ShowIncomingDamage.Patching.Core;

namespace STS2ShowIncomingDamage
{
    ...
    public static class Main
    {
        ...
        {
            patcher.RegisterPatches<CombatEventsPatch>();
            patcher.RegisterPatch<RecalcPeriodicPatch>();
            patcher.RegisterPatch<NIntentPatch>();
        }
    }
}
